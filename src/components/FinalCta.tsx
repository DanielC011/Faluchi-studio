...
export function FinalCta() {
  return (
    <section className="py-20 sm:py-28 bg-[#08090D] relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[350px] bg-[#2563FF]/20 blur-[130px] rounded-full" />
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4">
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 rounded-xl bg-[#2563FF] px-9 py-4 text-lg font-extrabold text-white shadow-xl shadow-[#2563FF]/30 hover:bg-[#1d4ed8] hover:shadow-[#2563FF]/50 active:scale-[0.98] transition-all duration-200"
          >
