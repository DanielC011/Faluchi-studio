        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {siteConfig.whyMe.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="h-10 w-10 rounded-xl bg-[#08090D] border border-[#232838] flex items-center justify-center text-[#2563FF] mb-4 group-hover:text-[#60A5FA] group-hover:border-[#2563FF]/40 transition-colors">
