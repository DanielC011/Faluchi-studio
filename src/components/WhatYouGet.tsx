    ...
    <section className="py-16 sm:py-24 border-b border-[#151821] bg-[#0A0D14] relative overflow-hidden">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4">
          {siteConfig.deliverables.map((item, idx) => (
            <motion.div
              key={item}
              ...
              className="flex items-center gap-3 p-4 rounded-xl bg-[#151821] border border-[#232838] hover:border-[#2563FF]/40 hover:-translate-y-0.5 transition-all duration-200"
            >
